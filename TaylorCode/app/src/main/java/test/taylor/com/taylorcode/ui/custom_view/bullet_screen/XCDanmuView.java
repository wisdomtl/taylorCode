...
public class XCDanmuView extends RelativeLayout {
    ...
    private int[] mBgResIds = {
            R.drawable.cootek_blue_gradient,
            R.drawable.cootek_radiobutton_active,
            R.drawable.cootek_radiobutton_normal,
            R.drawable.uki_coin_tag
    };
    private int[] mRowPos = {
            150,140,160,150
    };
...
//                    com.czm.xcdanmuview.XCDanmuView.this.removeView(mChildList.get(pos));
...
//        com.czm.xcdanmuview.XCDanmuView.this.startAnimation(animation);
        animation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                if(action == XCAction.HIDE){
//                    com.czm.xcdanmuview.XCDanmuView.this.setVisibility(View.GONE);
                }else{
//                    com.czm.xcdanmuview.XCDanmuView.this.setVisibility(View.VISIBLE);
                }
            }
            @Override
