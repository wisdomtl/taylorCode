...
class SearchHintFragment : BaseSearchFragment() {
    ...
    private val hintsAdapter by lazy(LazyThreadSafetyMode.NONE) {
        VarietyAdapter2().apply { addItemBuilder(SearchHintItemBuilder()) }
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        searchViewModel
            .searchState
            .collectIn(viewLifecycleOwner, minActiveState = Lifecycle.State.CREATED) { showState(it as TemplateSearchViewState) }
    }
    ...
    private fun showState(state: TemplateSearchViewState) {
