package test.taylor.com.taylorcode.ui.custom_view.crop_view;
...
import test.taylor.com.taylorcode.kotlin.LayoutKt;
...
public class OverlayView extends View {
    ...
    private boolean mShowCropFrame = true, mShowCropGrid = true;
    private boolean mCircleDimmedLayer = true;
    private int mDimmedColor = Color.parseColor("#CC0C0B1C");
...
//    private OverlayViewChangeListener mCallback;
    ...
    private int mRectRadius = dp2px(6);

    private boolean mShouldSetupCropBounds;

    {
        mTouchPointThreshold = LayoutKt.getDp(30);
        mCropRectMinSize = LayoutKt.getDp(100);
        mCropRectCornerTouchAreaLineLength = LayoutKt.getDp(10);
    }
...
//        }
    ...
    private void updateGridPoints() {
        ...
        mRoundRectPath.addRoundRect(mCropViewRect, mRectRadius, mRectRadius, Path.Direction.CW);
    }
...
//            canvas.clipRect(mCropViewRect, Region.Op.DIFFERENCE);
            canvas.clipPath(mRoundRectPath, Region.Op.DIFFERENCE);
        }
    ...
    protected void drawCropGrid(@NonNull Canvas canvas) {
        ...
        if (mShowCropFrame) {
            canvas.drawRoundRect(mCropViewRect, mRectRadius, mRectRadius, mCropFramePaint);
        }
    ...
    protected void processStyledAttributes(@NonNull TypedArray a) {
        mCircleDimmedLayer = true;
        mDimmedColor = Color.parseColor("#CC0C0B1C");
...
//        mShowCropGrid = a.getBoolean(R.styleable.ucrop_UCropView_ucrop_show_grid, DEFAULT_SHOW_CROP_GRID);
    ...
    private void initCropFrameStyle(@NonNull TypedArray a) {
        int cropFrameStrokeSize = 10;
        int cropFrameColor = Color.parseColor("#ffffff");
